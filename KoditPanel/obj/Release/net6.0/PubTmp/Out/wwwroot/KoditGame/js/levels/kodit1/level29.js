	...
	var worldTemp  = [
					    ...
					    [0,133, 98, 99, 98,116, 98,  5,  0,  0],
					    [0,134, 99, 98, 99,  1, 99,  1,  0,  0],
					    [0,135,115, 5,   1,  5,  1,  5,  0,  0],
	...
	var headerMessage = "<p class='infoTitle1'>Kod canavarları hazine avı oynuyor. Ellerindeki haritada son bir kod var. Buna göre hazine hangi karedeki define sandıǧında bulabilir misin?</p>";
	...
	if (lang == "en") {
	    headerMessage = "<p class='infoTitle1'>The code monsters are playing a treasure hunt. On their map, there’s one final code. According to it, in which square’s treasure chest is the treasure hidden?</p>";
