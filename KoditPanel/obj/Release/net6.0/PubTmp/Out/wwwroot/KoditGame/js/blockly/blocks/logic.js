...
Blockly.Constants.Logic.HUE = 210;
  ...
  Blockly.Blocks['is_wood_road'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(WOODROAD)
          .appendField(new Blockly.FieldImage("images//woodroad.png", 30, 30, "is_wood_road"));
  ...
  Blockly.Blocks['is_stone_road'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(STONEROAD)
          .appendField(new Blockly.FieldImage("images//stoneroad.png", 30, 30, "is_stone_road"));
      this.setOutput(true, null);
      this.setColour(230);
    this.setTooltip("");
    this.setHelpUrl("");
  ...
  Blockly.Blocks['is_there_wood'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(ISTHEREWOOD)
          .appendField(new Blockly.FieldImage("images//wood.png", 30, 30, "is_there_wood"));
      this.setOutput(true, null);
      this.setColour(230);
    this.setTooltip("");
    this.setHelpUrl("");
  ...
  Blockly.Blocks['is_there_fire'] = {
    init: function() {
      this.appendDummyInput()
          .appendField(ISTHEREFIRE)
          .appendField(new Blockly.FieldImage("images//fire.png", 30, 30, "is_there_fire"));
      this.setOutput(true, null);
      this.setColour(230);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
  ...
  // Block for comparison operator for boolean.
  {
    "type": "logic_compare_boolean",
    "message0": "%1 %2 %3",
    "args0": [
      {
        "type": "input_value",
