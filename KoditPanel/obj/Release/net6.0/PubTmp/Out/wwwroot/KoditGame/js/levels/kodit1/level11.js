	...
	var headerMessage = "<p class='infoTitle1'>Soru 10'da verilen 2 defa tekrarlanan kodun 3 defa tekrarlanmasını isteseydik, kodu nasıl yazardık ve varı noktası neresi olurdu?</p>";
	...
	if (lang == "en") {
	    headerMessage = "<p class='infoTitle1'>In Question 10, if we wanted the code repeated 3 times instead of 2, how would we write it, and what would be the destination square?</p>";
