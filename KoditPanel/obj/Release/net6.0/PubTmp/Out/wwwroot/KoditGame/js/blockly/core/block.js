...
Blockly.Block = function(workspace, prototypeName, opt_id) {
  ...
  this.whileHat = false;
  this.whileBottom = false;
  
  this.funcHat = false;
  this.funcBottom = false;
...
Blockly.Block.prototype.setStartBottom = function(newBoolean) {
   if (this.startBottom != newBoolean) {
    this.startBottom = newBoolean;
  }
};

Blockly.Block.prototype.setWhileHat = function(newBoolean) {
  if (this.whileHat != newBoolean) {
    this.whileHat = newBoolean;
  }
};

Blockly.Block.prototype.setWhileBottom = function(newBoolean) {
  if (this.whileBottom != newBoolean) {
    this.whileBottom = newBoolean;
  }
};

Blockly.Block.prototype.setFuncHat = function(newBoolean) {
  if (this.funcHat != newBoolean) {
    this.funcHat = newBoolean;
  }
};

Blockly.Block.prototype.setFuncBottom = function(newBoolean) {
  if (this.funcBottom != newBoolean) {
    this.funcBottom = newBoolean;
  }
};

Blockly.Block.prototype.setIfHat = function(newBoolean) {
  if (this.ifHat != newBoolean) {
    this.ifHat = newBoolean;
  }
};

Blockly.Block.prototype.setIfBottom = function(newBoolean) {
  if (this.ifBottom != newBoolean) {
    this.ifBottom = newBoolean;
  }
};

Blockly.Block.prototype.setElseHat = function(newBoolean) {
  if (this.elseTag != newBoolean) {
    this.elseTag = newBoolean;
  }
};
...
Blockly.Block.prototype.getStartBottom = function() {
  return this.startBottom;
};

Blockly.Block.prototype.getWhileHat = function() {
  return this.whileHat;
};

Blockly.Block.prototype.getWhileBottom = function() {
  return this.whileBottom;
};

Blockly.Block.prototype.getFuncHat = function() {
  return this.funcHat;
};

Blockly.Block.prototype.getFuncBottom = function() {
  return this.funcBottom;
};

Blockly.Block.prototype.getIfHat = function() {
  return this.ifHat;
};

Blockly.Block.prototype.getIfBottom = function() {
  return this.ifBottom;
};

Blockly.Block.prototype.getElseTag = function() {
  return this.elseTag;
};
