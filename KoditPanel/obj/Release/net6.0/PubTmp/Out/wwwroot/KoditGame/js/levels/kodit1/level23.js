	...
	var headerMessage = "<p class='infoTitle1'>Üstteki haritada Zodi'nin aǧaca gitmesini saǧlamak için 'eǧer' komutunu kullanarak bir algoritma yazabilir misin?</p>";
	...
	if (lang == "en") {
	    headerMessage = "<p class='infoTitle1'>On the map above, can you write an algorithm using the “if” command to make Zodi reach the tree?</p>";
