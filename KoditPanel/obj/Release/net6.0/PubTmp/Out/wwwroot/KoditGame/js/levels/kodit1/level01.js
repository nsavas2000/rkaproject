	...
	var headerMessage = "<p class='infoTitle1'>Lodi 🍏elmaya nasıl gideceğini bilmiyor. Ona yol göstermek için bir kod yazılmış. kod fişlerine bakıp hangi elmaya gittiğini söyleyebilir misin?</p>";
	...
	if (lang == "en") {
	    headerMessage = "<p class='infoTitle1'>Lodi doesn’t know how to get to the 🍏apple. Can you look at the code cards and tell which apple he goes to?</p>";
